...
def _write_crossbuild_file(file):
    ...
    with open(file, 'w') as f:
        ...
        f.write('SET(CMAKE_C_COMPILER   ' + _info.crossbuild_host + '-gcc)\n')
        f.write('SET(CMAKE_CXX_COMPILER ' + _info.crossbuild_host + '-g++)\n')
        f.write('SET(CMAKE_RC_COMPILER  ' + _info.crossbuild_host + '-windres)\n')
        f.write('SET(CMAKE_FIND_ROOT_PATH ' + crossbuild_root_path + ')\n')
